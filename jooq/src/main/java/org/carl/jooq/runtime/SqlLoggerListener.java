...
public class SqlLoggerListener extends LoggerListener {
            ...
            if (anyAbbreviations) {
                if (context.queryPartsLength() == 1) {
                    context.renderContext().sql(
                            " -- Bind values may have been abbreviated for DEBUG logging. Use TRACE logging"
                                    + " for very large bind variables.");
                }
            }
        }
    }
    ...
    static void setFinalField(Object reflectObj, Class<?> clsObj, String fieldName,
            Object newValue) {
        if (clsObj == null) {
        ...
        try {
            ...
            String msg = "reflect object class: "
