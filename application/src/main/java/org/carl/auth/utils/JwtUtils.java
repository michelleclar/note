...
public class JwtUtils {
  ...
  public static JwtPojo convexAccentToken(JWTParser jwtParser, String accentToken)
      throws ParseException {
    JsonWebToken userinfo = jwtParser.parseOnly(accentToken);
    long expirationTime = userinfo.getExpirationTime();
    if (expirationTime > System.currentTimeMillis()) {
      return new JwtUtils.JwtPojo(accentToken);
    }
    User userInfo = getUserInfo(userinfo);
    String s = JwtUtils.generateAccentToken(userInfo);
    return new JwtPojo(s);
